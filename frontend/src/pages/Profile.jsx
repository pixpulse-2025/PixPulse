    ...
    return (
        <div className="min-h-screen bg-[#0B0D10] pt-32 pb-20">
            ...
            <div className="container mx-auto max-w-[1400px] px-6 py-8">
                {/* Tab Navigation */}
                <div className="flex gap-2 bg-[#141821] rounded-lg p-2 border border-white/5 mb-8 max-w-md">
                    {[
                ...
                <div className="min-h-[400px]">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {["Digital Art", "Illustration", "3D Design", "Photography", "UI/UX"].map((skill) => (
                                            <span key={skill} className="px-4 py-2 bg-[#141821] text-gray-300 border border-white/10 rounded-lg text-sm font-medium">
                                                {skill}
                                            </span>
                                        ))}
                                    </div>
                    ...
                    {activeTab === "collections" && (
                        <div className="card-surface py-20 text-center">
                            ...
                            <p className="text-gray-400">Create collections to organize your favorite artworks</p>
                        </div>
                    )}
                </div>
            </div>
