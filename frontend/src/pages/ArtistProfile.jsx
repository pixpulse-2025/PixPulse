                        ...
                        <div className="flex-1 text-center md:text-left space-y-6">
                            <div>
                                ...
                                <p className="text-base text-gray-400">
                                    {artist.artistType || (artist.role ? artist.role.charAt(0).toUpperCase() + artist.role.slice(1) : "Artist")} • Joined {new Date(artist.createdAt).getFullYear()}
                                </p>
                            </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {artist?.website && (
                                            <div className="flex items-center gap-3 text-gray-300">
                                                ...
                                                <a href={artist.website.startsWith('http') ? artist.website : `https://${artist.website}`} target="_blank" rel="noopener noreferrer" className="text-sm text-[#8B5CF6] hover:underline">
                                                    {artist.website}
                                                </a>
                                            </div>
                                        )}
                                        ...
                                        {artist?.socialLinks && Object.values(artist.socialLinks).some(handle => handle) && (
